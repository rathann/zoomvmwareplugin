...
%global __requires_exclude ^lib\(icu\(data\|i18n\|uc\)\|Qt5\(Core\|DBus\|Gui\|Network\|Qml\|Quick\|Script\|Svg\|Widgets\|X11Extras\|XcbQpa\)\|vdpservice\)
%else
